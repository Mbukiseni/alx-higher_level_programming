#!/usr/bin/python3
"""Define classes for the singly-linked list."""


class Node:
    """Represent node in the singly-linked list."""
...
class SinglyLinkedList:
    ...
    def __init__(self):
        """Initalize th new SinglyLinkedList."""
        self.__head = None

    def sorted_insert(self, value):
        """Insert new Node to a SinglyLinkedList.
